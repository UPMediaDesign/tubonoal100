...
<!--[if lt IE 9]>
<link href='https://fonts.googleapis.com/css?family=Roboto:500,500italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
...
<div class="loading"><img id="logo" src="img/logo.png" width="511" height="94" alt="Tu Bono al 100%"/>
 ...
 <a href="javascript:void(0)"  id="inicio" class="uc">Volver al Inicio</a>
 </div>

<header id="header">
	<h1 class="ucbo"><img id="logo" src="img/logo.png" width="511" height="94" alt="Tu Bono al 100%"/></h1>
</header>

<section id="menu_container" class="uc">
    <a class="uc close" href="javascript:void(0);">X</a>
     <article id="text_menu" class="uclo">
   ...
   Queremos que recibas el benefico total de tu bono, revisa las alternativas que te permitirán obtener el 100% de su bono sin pagar impuestos y/o reducir el efecto impuestos.
	...
	<ul id="menu_principal">
        ...
        <li><a class="menu2" href="javascript:void(0)">¿Qué beneficios tengo al hacer APV?</a></li>
