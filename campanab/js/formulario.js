$(document).ready(function(){
			...
			$("#FormularioContacto").validate({
				event: "blur",rules: {'nombre': "required",'apellido': "required", 'email': "required email", 'telefono': "required"},
				messages: {'nombre': "Ingresa tu nombre",'apellido': "Ingresa tu apellido",'email': "Ingresa una direcci&oacute;n de e-mail v&aacute;lida",'telefono': "Ingresa un tel&eacute;fono"},
				...
				submitHandler: function(form){
					...
					$.ajax({
						...
						processData: true,
						data: "nombre="+escape($('#Nombre').val())+"&apellido="+escape($('#Apellido').val())+"&rut="+escape($('#RUT').val())+"&email="+escape($('#Email').val())+"&telefono="+escape($('#Telefono').val()),
						success: function(msg){
							...
							ga('send', 'event', 'Formulario Cuenta 2', 'Submit', $("#Email").val() );
